...
class Secwin_Licence4EditRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"lic_guid" => "filled|string",
				"lic_sitelimiter" => "filled|string",
				"lic_licencedto" => "filled|string",
				"lic_dealer" => "nullable|string",
				"lic_product" => "filled|string",
				...
				"lic_licencetype" => "filled|numeric",
